    ...
    <section id="contact" className="card my-20 relative overflow-hidden shadow-md">
      ...
      <div className="p-8 md:p-12 lg:p-16 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
        ...
        <div className="relative order-first lg:order-last">
          <div className="absolute inset-0 bg-gradient-to-tr from-blue-500/30 to-violet-500/30 blur-2xl rounded-3xl" />
          <img
            src="https://cdn.poehali.dev/projects/fb2a1602-a01f-4a6b-9e2e-c4b982da0b91/files/7950b80a-2227-45b3-af6d-d24e62711fed.jpg"
            alt="Автоматизация бизнеса под ключ"
